...
def register_topology(dataset, adj):
    MAX_HOP = 100
    topo_file = f"/home/sp429ltx/fuxian/zitu-main/dataset/topology_dist/{dataset.lower()}_padding.pt"
...
if __name__ == '__main__':
    ...
    Args:
        dataset_name: BlogCatalog, Flickr,  ACM,  cora,  citeseer,  pubmed,books
    ...
    dataset_name = 'Amazon'
    _,adj, _, _, _, _, _, _ = load_graph(dataset_name)
